                ...
                <div className="tools-child-1">
                    <div>
                        ...
                        <div style={{marginLeft: 10, marginTop: 18}}>
                            ...
                            <a href="/home" className="tools-a" >Create an Online Store</a>
                    ...
                    <div>
                        ...
                        <div style={{marginLeft: 10, marginTop: 18}}>
                            ...
                            <a href="/home" className="tools-a" >Create an Free Blog</a>
                    ...
                    <div>
                        ...
                        <div style={{marginLeft: 10, marginTop: 32}}>
                            ...
                            <a href="/home" className="tools-a" >Get Custom Domain Names</a>
                        </div>
                    </div>
                </div>
                <div className="tools-child-2">
                    ...
                    <div>
                        ...
                        <div style={{marginLeft: 10, marginTop: 40}}>
                            ...
                            <a href="/home" className="tools-a" >Discover Wix Bookings</a>
                    ...
                    <div>
                        ...
                        <div style={{marginLeft: 10, marginTop: 40}}>
                            ...
                            <a href="/home" className="tools-a" >Try Wix Logo Maker</a>
                    ...
                    <div>
                        ...
                        <div style={{marginLeft: 10, marginTop: 35}}>
                            ...
                            <a href="/home" className="tools-a" >Find Out More</a>
                        </div>
                    </div>
